...
import { getWhitelistedUser, removeAutoDailyUser, saveAutoDailyUser } from '../utils/functions/database';
...
const command: Command = {
    ...
    execute: async (interaction) => {
        ...
        const isEnabled = await getWhitelistedUser(interaction.user.id);
