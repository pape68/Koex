import { ComponentType, InteractionType, ModalSubmitInteraction, TextInputStyle } from 'discord.js';
    ...
    execute: async (client: ExtendedClient, interaction: ModalSubmitInteraction) => {
        ...
        await basicInstance
            ...
            .then(async (res) => {
                ...
                await bearerInstance
                    .post(`/account/api/public/account/${account_id}/deviceAuth`, {})
                    .then(async (res) => {
                        const device_id = res.data.deviceId;
                            ...
                            .then(async (tokenRes) => {
                                ...
                                if (error) {
                                    ...
                                    return interaction.editReply(
                                        'An interal occurred. Please try again.'
                                    );
                                }
                                    ...
                                    components: [
                                        {
                                            ...
                                            components: [
                                                (client.interactions.get('login') as Button).options
                                            ]
                                        }
                                    ]
                                });
